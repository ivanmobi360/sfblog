...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $blog1->setUser($manager->merge($this->getReference('admin')));
        ...
        $blog2->setUser($manager->merge($this->getReference('admin')));
        ...
        $blog3->setUser($manager->merge($this->getReference('admin')));
        ...
        $blog4->setUser($manager->merge($this->getReference('admin')));
        ...
        $blog5->setUser($manager->merge($this->getReference('maxime')));
